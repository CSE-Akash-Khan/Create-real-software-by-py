...
os.environ['TK_LIBRARY'] = r"C:\Users\Dell\AppData\Local\Programs\Python\Python37-32\tcl\tk8.6"

executables = [cx_Freeze.Executable("vpad.py", base=base, icon="icon.ico",shortcutName='Vpad',shortcutDir='DesktopFolder')]
